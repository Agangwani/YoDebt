package com.howtodoinjava.demo.company;
...
public class Mortgage {
    ...
    public static double getPV(double discountRate, Mortgage mortgage) {
        double pv=0;
    ...
    public static double calculateIR(String schoolRank, String schoolLocation, String courseStudy){
        double schoolRate = 0;
